      ...
      <div className="container mx-auto px-6 lg:px-12">
        <div className="max-w-3xl mx-auto text-center">
          <AnimatedSection>
            ...
            <p className="font-sans text-lg text-muted-foreground font-light leading-relaxed mb-12 max-w-xl mx-auto">
          ...
          <AnimatedSection delay={200}>
            ...
            <a
              ...
              className="group inline-flex items-center gap-4 font-serif text-2xl md:text-3xl font-medium text-foreground hover:text-primary transition-colors duration-300"
            >
              <span className="hover-underline">workmail.hraj@gmail.com</span>
              <svg
                className="w-6 h-6 transition-transform duration-300 group-hover:translate-x-2 group-hover:-translate-y-1"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                strokeWidth="1.5"
            ...
            <div className="flex items-center justify-center gap-8">
              {[
                ...
                <a
                  ...
                  className="hover-underline font-sans text-sm font-medium tracking-wide text-muted-foreground hover:text-foreground transition-colors duration-300 uppercase"
                >
                  {social.label}
                </a>
              ))}
